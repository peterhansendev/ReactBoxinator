...
const ShippingFee = ({
  ...
  sendShippingFee(shippingFee);
  sendWeight(weight);
  sendTotalCost(totalCost);
  sendDestination(destination);
  sendPackageType(packageType);

  const handleCountryChange = (event) => {
    setShippingFee(event.target.value);
    setDestination(event.target.options[event.target.selectedIndex].text);
  };

  const handlePackageChange = (event) => {
    setWeight(event.target.value);
    setPackageType(event.target.id);
  };

  useEffect(() => {
    if (shippingFee && weight) {
  ...
  return (
    <div id="shippingCal">
      <div className="flex">
        <div id="handling" className="w-full  md:w-1/4 px-1 mb-4">
        ...
        <div id="shipping" className="w-full  md:w-1/4 px-1 mb-4 ">
          <h2 className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
            Shipping Fee
          </h2>
          <span
        ...
        <div id="weight" className="w-full  md:w-1/4 px-1 mb-4">
          <h2 className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
            Weight
          </h2>
          <span
        ...
        <div id="total" className="w-full  md:w-1/4 px-1 mb-4">
        <h2 className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
          Total cost 
        </h2>
        <span
      ...
      <h2 className="block uppercase tracking-wide text-gray-700 text-xs font-bold w-full mb-6 md:mb-2">
        Packages
      </h2>
      <div id="input">
        <input
        ...
        <input
          ...
          value="2"
        />
        <label htmlFor="Humble"> Humble</label>
        <br />
        <input
          onChange={handlePackageChange}
          name="packages"
...
const ShippingFee = ({sendShippingFee, sendWeight, sendTotalCost, sendDestination, sendPackageType}) => {
  ...
  return (
    <div id="shippingCal">
      ...
      <span id="col2">200 DKK</span>
      <h2>
        <strong>Shipping Fee: </strong>
      </h2>
      <span id="col2">{shippingFee} DKK</span>
      <h2>
        <strong>Weight:</strong>
      </h2>
      <span id="col2">{weight} KG</span>
      ...
      <span id="col2"> {totalCost} DKK</span>
    </div>
  );
};
